var BeautyZone = function() {
    ...
    var e = $(window).width(),
        ...
        i = function() {
            ...
            if (jQuery(".scroll").unbind().on("click", function(e) {
                    if (e.preventDefault(), "" !== this.hash) {
                        var t = jQuery(this.hash).offset().top,
                            n = parseInt(jQuery(".onepage").css("height"), 10);
                ...
                var t = parseInt($(".main-bar").css("height"), 10);
                jQuery('.navbar-nav-scroll a[href^="#"]').on("click", function(e) {
                    e.preventDefault(), jQuery(document).off("scroll"), jQuery(".navbar-nav-scroll a").each(function() {
                        jQuery(this).parent("li").removeClass("active")
                    }), jQuery(this).parent("li").addClass("active");
                    var n, i = $(this.hash);
                    i.length > 0 && jQuery("html, body").stop().animate({
        ...
        a = function(e) {
            ...
            jQuery(".navbar-nav-scroll > li").each(function() {
                var e = jQuery(this).find("a:first"),
                    n = jQuery(e.attr("href")),
                    i = parseInt($(".main-bar").css("height"), 10);
                n.offset().top - i - 20 <= t && n.offset().top + n.height() > t ? (jQuery(".navbar-nav-scroll a").parent("li").removeClass("active"), e.parent("li").addClass("active")) : e.parent("li").removeClass("active")
            })
        },
        o = function() {
            $(".header").css("height", "");
        ...
        h = function(e) {
            ...
            var t, n = 0,
                ...
                a = [];
            $(e).each(function() {
                if (t = $(this), $(t).height("auto"), i != (topPostion = t.position().top)) {
                    for (currentDiv = 0; currentDiv < a.length; currentDiv++) a[currentDiv].height(n);
                    a.length = 0, i = topPostion, n = t.height(), a.push(t)
                } else a.push(t), n = n < t.height() ? t.height() : n;
                for (currentDiv = 0; currentDiv < a.length; currentDiv++) a[currentDiv].height(n)
            })
        },
        u = function() {
        ...
        f = function() {
            ...
            }), jQuery(".btn-file :file").on("fileselect", function(e, t, n) {
                input = jQuery(this).parents(".input-group").find(":text");
                var i = t > 10 ? t + " files selected" : n;
        ...
        W = function() {
            jQuery(window).on("resize", function() {
                jQuery(".modal:visible").each(T), jQuery(".equal-wraper").length && h(".equal-wraper .equal-col"), u()
            })
        },
        F = function() {
        ...
        I = new Date;
    monthNames = ["January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"], I.setMonth(I.getMonth() + 1), I = I.getDate() + " " + monthNames[I.getMonth()] + " " + I.getFullYear();
    var P = function() {
        ...
        A = function() {
            if ($("#smartwizard").length > 0) {
                $("#smartwizard").on("showStep", function(e, t, n, i, a) {
                    "first" === a ? $("#prev-btn").addClass("disabled") : "final" === a ? $("#next-btn").addClass("disabled") : ($("#prev-btn").removeClass("disabled"), $("#next-btn").removeClass("disabled"))
                });
                var e = $("<button></button>").text("Finish").addClass("btn btn-info").on("click", function() {
                        alert("Finish Clicked")
                    }),
                    t = $("<button></button>").text("Cancel").addClass("btn btn-danger").on("click", function() {
        ...
        M = function() {
            jQuery(".dz-demo-content").length > 0 && (new PerfectScrollbar(".dz-demo-content"), $(".dz-demo-trigger").on("click", function() {
    ...
    return {
        init: function() {
            D(), x(), q(), i(), s(), o(), t(), l(), c(), r(), d(), F(), u(), f(), m(), g(), b(), z(I), C(), S(), n(), _(), W(), P(), A(), M(), Z(), L(), jQuery(".modal").on("show.bs.modal", T)
        },
        load: function() {
            B(), w(), k(), h(".equal-wraper .equal-col"), v(), p(), E()
        },
        handleMasonryFilter: function() {
            y()
        },
        resize: function() {
            e = $(window).width(), s(), S(), g(), o()
        }
    }
}();
jQuery(document).ready(function() {
    BeautyZone.init(), jQuery(".navicon").on("click", function() {
    ...
    BeautyZone.load(), setTimeout(function() {
